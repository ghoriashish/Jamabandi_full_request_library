            ...
            for i in range(2, len(check_total_district)):
                ...
                for j in range(2, len(check_total_tehsil)):
                    ...
                    for k in range(2, len(check_total_village)):
                        ...
                        check_khasra_total = year_tree.xpath("//*[contains(text(),'Khasra')]//..//select//option")
                        for l in range(2, len(check_khasra_total)):
                            try:
                                data_list = []
                                khasra_number = \
                                year_tree.xpath(f"//*[contains(text(),'Khasra')]//..//select//option[{l}]//text()")[0]
                                khasra_payload = {
                                ...
                                nakal = khasra_tree.xpath("//td//a[contains(text(),'Nakal')]")
                                ...
                                nakal_tree = html.fromstring(nakal_response.text)
